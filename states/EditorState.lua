...
function EditorState.draw()
	...
	love.graphics.setColor(0,0,0,this.messageop)
	love.graphics.print(this.message, (love.graphics.getWidth() - font:getWidth(this.message))/2+1, (game.offY-font:getHeight())/2+1)
